        ...
        <div class="flex">
            <div class="container">
                <div class="flex items-center space-x-3 mb-10">
                    ...
                    <h2 class="text-2xl font-bold mb-1">Data Sales</h2>
                </div>
                    ...
                    <table class="min-w-full bg-white border border-gray-300 mt-6">
                        <thead class="bg-gray-100">
                            <tr>
                                ...
                                <th class="px-4 py-2 text-left">Alamat lengkap</th>
                                <th class="px-4 py-2 text-left">No. Hp/WhatsApp</th>
                        ...
                        <tbody>
                            <tr class="border-b">
                                ...
                                <td class="px-4 py-2">Pasar minggu</td>
                                <td class="px-4 py-2">083183471234</td>
                            ...
                            <tr class="border-b">
                                ...
                                <td class="px-4 py-2">Jakarta, 5 Juni 1990</td>
                                <td class="px-4 py-2">Pondok cabe</td>
                                <td class="px-4 py-2">083183471234</td>
                                <td class="px-4 py-2">Aktif</td>
                                <td class="px-4 py-2 flex space-x-2">
                                    <button class="flex items-center space-x-1 bg-gray-400 text-white py-2 px-2 rounded">
                            ...
                            <tr class="border-b">
                                ...
                                <td class="px-4 py-2">L</td>
                                <td class="px-4 py-2">Jakarta, 2 Juli 1992</td>
                                <td class="px-4 py-2">Pasar minggu</td>
                                <td class="px-4 py-2">083183471234</td>
                                <td class="px-4 py-2">Aktif</td>
                                <td class="px-4 py-2 flex space-x-2">
                            ...
                            <tr class="border-b">
                                ...
                                <td class="px-4 py-2">L</td>
                                <td class="px-4 py-2">Jakarta, 23 Januari 1982</td>
                                <td class="px-4 py-2">Pasar minggu</td>
                                <td class="px-4 py-2">083183471234</td>
                                <td class="px-4 py-2">Aktif</td>
                                <td class="px-4 py-2 flex space-x-2">
