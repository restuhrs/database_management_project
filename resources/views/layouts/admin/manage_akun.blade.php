            ...
            <table class="w-full bg-white border border-gray-300 shadow rounded text-sm">
                ...
                <tbody class="text-gray-700">
                    ...
                    <tr class="border-b hover:bg-gray-100 transition duration-200">
                        <td class="px-3 py-2 text-center">{{ $users->id }}</td>
                        <td class="px-3 py-2 text-center">{{ $users->cabang }}</td>
                        <td class="px-3 py-2 text-center">{{ $users->username }}</td>
                        <td class="px-3 py-2 text-center">{{ $users->nama }}</td>
                        <td class="px-3 py-2 text-center">{{ $users->role }}</td>
