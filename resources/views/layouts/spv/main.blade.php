...
<body class="m-0 font-sans text-base antialiased font-normal leading-default bg-gray-50 text-slate-500">
    ...
    $pages = [
    'spv.dashboard' => ['title' => 'Hi, have a nice day', 'breadcrumb' => ['Home', 'Dashboard']],
    'spv.data_cust' => ['title' => 'Hi, have a nice day', 'breadcrumb' => ['Home', 'Data Customer']],
    'spv.data_sales' => ['title' => 'Hi, have a nice day', 'breadcrumb' => ['Home', 'Data Sales']],
    'spv.laporan' => ['title' => 'Hi, have a nice day', 'breadcrumb' => ['Home', 'Laporan']],
    'spv.manage_akun' => ['title' => 'Hi, have a nice day', 'breadcrumb' => ['Home', 'Manage Akun']],
    ];
            ...
            <nav>
                ...
                <ol class="flex flex-wrap pt-1 mr-12 bg-transparent rounded-lg sm:mr-16">
                    ...
                    <li class="text-sm leading-normal">
                        <a class="font-bold text-blue-600 transition-colors hover:text-blue-800" href="{{ route('spv.dashboard') }}">{{ $crumb }}</a>
                    </li>
                    @endif
                    @endforeach
                </ol>
